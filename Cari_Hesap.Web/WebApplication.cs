...
namespace Cari_Hesap.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class Cari_HesapAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private Cari_Hesap.Module.Cari_HesapModule module3;
        private Cari_Hesap.Module.Web.Cari_HesapAspNetModule module4;
        ...
        static Cari_HesapAspNetApplication() {
        ...
        #endregion
        public Cari_HesapAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void Cari_HesapAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new Cari_Hesap.Module.Web.Cari_HesapAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.Cari_HesapAspNetApplication_DatabaseVersionMismatch);
